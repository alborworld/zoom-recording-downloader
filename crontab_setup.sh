...
CRON_JOB="$CRON_SETTINGS . /root/project_env.sh && python3 /app/zoom-recording-downloader.py >> ${LOG_DIRECTORY:-/var/log/zoom-recording-downloader}/app.log 2>> ${LOG_DIRECTORY:-/var/log/zoom-recording-downloader}/error.log && cat ${LOG_DIRECTORY:-/var/log/zoom-recording-downloader}/app.log ${LOG_DIRECTORY:-/var/log/zoom-recording-downloader}/error.log >> /proc/1/fd/1 2>> /proc/1/fd/2"
